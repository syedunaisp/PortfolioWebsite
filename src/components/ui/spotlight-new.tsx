    ...
    return (
        <motion.div
            ...
            style={{
                ...
                maskImage: "radial-gradient(ellipse at center, transparent 20%, black 60%, transparent 90%)",
                WebkitMaskImage: "radial-gradient(ellipse at center, transparent 20%, black 60%, transparent 90%)",
            }}
        />
    );
};
